...
//  int y = (tft.height() - 300) / 2 - 1;
  ...
  tft.setRotation(2);  // portrait
  tft.fillScreen(random(0xFFFF));
  drawArrayJpeg(pirooz, sizeof(pirooz), 0, 0); // Draw a jpeg image stored in memory
  delay(2000);


  tft.setRotation(1);  // portrait
  tft.fillScreen(random(0xFFFF));
  drawArrayJpeg(flag_iran, sizeof(flag_iran), 0, 0); // Draw a jpeg image stored in memory
  delay(2000);
