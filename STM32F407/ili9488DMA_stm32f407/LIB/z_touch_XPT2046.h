...
//#define BY -15.0f
#define AX 0.010792f
#define BX -19.667416f
#define AY 0.015927f
#define BY -24.156017f
#endif
 ...
 **********************************************************************************/
#define TOUCHGFX_TIMING 50		//delay between 2 consecutive Touch_GotATouch(2)readings		(0=disabled)
...
#define TOUCHGFX_REPEAT_IT 1	// after a long touch (dragging) repeat X times last position	(0=disabled)
