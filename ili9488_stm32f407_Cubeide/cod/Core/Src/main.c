...
int main(void)
{
  ...
  Displ_CLS(BLACK);
 // Displ_drawCircle(0,0,100,RED);
  //Displ_Line(0,1OO,100,100,BLUE);
//  Displ_WChar(100,100,"HELLO",Font20,20,RED,WHITE);
 // Displ_CString(0,0,0,0, "RESULTS", Font24, 1, WHITE,BLUE);
  Displ_PerfTest();
  /* USER CODE END 2 */
